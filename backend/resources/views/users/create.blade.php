                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="" name="name" placeholder="insert your name ...">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Email</label>
                                            <input type="email" class="form-control" value="" name="email" placeholder="insert your email ...">
                                        </div>
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="" name="place_birth" placeholder="insert your birth place ...">
                                        </div>
                                    </div>
                                    <div class="mb-3">
