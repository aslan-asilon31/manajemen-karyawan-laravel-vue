...
<head>
    ...
    <title> Users - CakeAdmin Bootstrap 5 Demo </title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset("cakeadmin/favicon.png")}}"/>
    ...
    <!-- Main style file -->
    <link rel="stylesheet" href="{{ asset("cakeadmin/css/app.css")}}" type="text/css">
    </head>
<body>
...
<div class="menu">
    <div class="menu-header">
        <a href="./dashboard.html" class="menu-header-logo">
            <img src="{{ asset("cakeadmin/logo.svg")}}" alt="logo">
        ...
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center" data-bs-toggle="dropdown">
                <div class="avatar me-3">
                    <img src="{{ asset("cakeadmin/images/user/man_avatar5.jpg")}}"
                         class="rounded-circle" alt="image">
                </div>
                <div>
                    <div class="fw-bold">Sulaslan Setiawan</div>
...
<div class="layout-wrapper">
    ...
    <a href="./dashboard.html" class="logo">
        <img width="100" src="{{ asset("cakeadmin/logo.png")}}" alt="logo">
    </a>
    <!-- ./ Logo -->
...
<!-- JQuery -->
<script src="{{ asset("cakeadmin/libs/jquery-3.7.1.min.js")}}"></script>

<!-- Nicescroll -->
<script src="{{ asset("cakeadmin/libs/nicescroll.js")}}"></script>

<!-- Examples -->
<script src="{{ asset("cakeadmin/js/examples/users.js")}}"></script>

<!-- Main Javascript file -->
<script src="{{ asset("cakeadmin/js/app.js")}}"></script>
</body>
</html>
